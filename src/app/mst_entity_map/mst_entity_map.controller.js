...
const model     = require('./mst_entity_map.model');
const validate  = require('./mst_entity_map.validation');
const util          = require('../../utility/util');



router.post('/v1/mst-entity-map/landingData', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
    if (validate.listReq(reqData)) {
        const resp = await model.getLandingData(req.body);
...
router.post('/v1/mst-entity-map/list', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
    if (validate.listReq(reqData)) {
...
router.post('/v1/mst-entity-map/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-entity-map/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-entity-map/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
