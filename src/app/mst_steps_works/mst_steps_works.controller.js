...
const model         = require('./mst_steps_works.model');
const validate      = require('./mst_steps_works.validation');
const util          = require('../../utility/util');


router.post('/v1/mst_steps_works/list', async (req, res) => {
...
router.post('/v1/mst_steps_works/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_steps_works/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_steps_works/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
