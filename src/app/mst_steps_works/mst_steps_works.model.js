const dao = require('./mst_steps_works.dao');
...
module.exports.add = async (data) => {
    try {
        ...
        if (!isExists) {
            ...
            return { success: false, status: util.statusCode.NAME_EXISTS, message: 'Step details with same details already exists', response: null }
        }
    } catch (e) {
        return { success: false, status: util.statusCode.SOME_ERROR_OCCURRED, message: 'Some error occurred', response: null }
    }
