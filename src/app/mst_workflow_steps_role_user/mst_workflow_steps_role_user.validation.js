...
module.exports.getWorkflowUser = (data) => {
    let errcounter = 0;
    if (data.reraid === undefined || data.reraid == null) {
        util.createLog("reraid is missing");
        errcounter++;
...
module.exports.addReq = (data) => {
    ...
    if (data.workflowuserid === undefined || data.workflowuserid === null || data.workflowuserid === 0) {
        util.createLog("workflowuserid is missing");
        errcounter++;
    }
...
module.exports.updateReq = (data) => {
    ...
    if (data.workflowuserid === undefined || data.workflowuserid === null) {
        util.createLog("workflowuserid is missing");
        errcounter++;
    }
