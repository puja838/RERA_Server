...
const model         = require('./mst_field_group.model');
const validate      = require('./mst_field_group.validation');
const util          = require('../../utility/util');



router.post('/v1/mst-field-group/getFieldListByGroup', async (req, res) => {
...
router.post('/v1/mst-field-group/list', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-field-group/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-field-group/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-field-group/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-field-group/addFieldsInGroup', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-field-group/updateSequence', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
