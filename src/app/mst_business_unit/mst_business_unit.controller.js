...
const model         = require('./mst_business_unit.model');
const validate      = require('./mst_business_unit.validation');
const util          = require('../../utility/util');


router.post('/v1/mst_business_unit/list', async (req, res) => {
...
router.post('/v1/mst_business_unit/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_business_unit/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_business_unit/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
