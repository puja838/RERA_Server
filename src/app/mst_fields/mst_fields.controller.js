...
const model     = require('./mst_fields.model');
const validate  = require('./mst_fields.validation');
...
router.post('/v1/mst-fields/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-fields/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-fields/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
