...
const model         = require('./mst_workflow.model');
const validate      = require('./mst_workflow.validation');
const util          = require('../../utility/util');


router.post('/v1/mst_workflow/list', async (req, res) => {
...
router.post('/v1/mst_workflow/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_workflow/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_workflow/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
