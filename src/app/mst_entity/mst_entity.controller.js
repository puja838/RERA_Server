...
const model     = require('./mst_entity.model');
const validate  = require('./mst_entity.validation');
const util          = require('../../utility/util');



router.post('/v1/mst-entity/list', async (req, res) => {
...
router.post('/v1/mst-entity/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-entity/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst-entity/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
