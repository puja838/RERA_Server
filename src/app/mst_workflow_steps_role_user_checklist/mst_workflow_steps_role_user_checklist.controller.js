...
const model         = require('./mst_workflow_steps_role_user_checklist.model');
const validate      = require('./mst_workflow_steps_role_user_checklist.validation');
const util          = require('../../utility/util');


router.post('/v1/mst_workflow_steps_role_user_checklist/list', async (req, res) => {
...
router.post('/v1/mst_workflow_steps_role_user_checklist/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_workflow_steps_role_user_checklist/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_workflow_steps_role_user_checklist/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
