...
const model         = require('./mst_business_unit_type.model');
const validate      = require('./mst_business_unit_type.validation');
const util          = require('../../utility/util');


router.post('/v1/mst_business_unit_type/list', async (req, res) => {
...
router.post('/v1/mst_business_unit_type/add', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_business_unit_type/update', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
...
router.post('/v1/mst_business_unit_type/delete', async (req, res) => {
    let reqData = validator.requestFilter(req.body);
